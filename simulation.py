...
def main():
    ...
    for i in range(number_of_runs):
        ...
        try:        
            algo_avg_snr_i, stat_avg_snr_i, dyn_avg_snr_i, algo_cnt_i, stat_cnt_i, dyn_cnt_i \
                = sim(surface_obj,units_num,soldiers_in_unit_num[i],drones_num,end_time,battery[i%100]/100)
...
def sim(surface_obj, units_num, soldiers_in_unit_num, drones_num, end_time, battery):
    ...
    # print("finish")
    return algo_avg_snr_i, stat_avg_snr_i, dyn_avg_snr_i, algo_cnt_i, stat_cnt_i, dyn_cnt_i
